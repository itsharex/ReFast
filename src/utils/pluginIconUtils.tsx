 ...
 * 根据插件ID获取对应的图标 SVG
 */
export function getPluginIcon(pluginId: string): React.ReactElement {
 ...
 * 根据插件ID获取图标背景渐变色
 */
export function getPluginIconBg(pluginId: string): string {
  switch (pluginId) {
    case "everything_search":
 ...
 * 根据插件ID获取图标颜色
 */
export function getPluginIconColor(pluginId: string): string {
  switch (pluginId) {
    case "everything_search":
